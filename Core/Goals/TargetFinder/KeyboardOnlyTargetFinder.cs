...
{
    public class KeyboardOnlyTargetFinder: ITargetFinder
    {
        ...
        public KeyboardOnlyTargetFinder(ILogger logger, ConfigurableInput input, ClassConfiguration classConfig, Wait wait, PlayerReader playerReader, IBlacklist blacklist, NpcNameTargeting npcNameTargeting)
        {
            this.logger = logger;
