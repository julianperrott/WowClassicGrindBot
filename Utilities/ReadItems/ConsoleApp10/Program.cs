    ...
    internal class Program
    {
        public class Item
        {
            ...
            public static void Extract()
            {
                ...
                ExtractItemTemplate("item_template", extractLine);
        ...
        public class Creature
        {
            ...
            public static void Extract()
            {
                ...
                ExtractItemTemplate("creature_template", extractLine);
        ...
        private static void ExtractItemTemplate(string tablename, Action<string> extractLine)
        {
            var stream = File.OpenText(@"C:\Users\julian\Desktop\ClassicDB_1_11_z2757.sql");

            bool isInItemTemplateInsert = false;
            ...
            while (line != null)
            {
                ...
                if (isInItemTemplateInsert)
                {
                    if (line.StartsWith("VALUES"))
                    {
                    }
                    else if (line.Contains("INSERT INTO") && !line.Contains($"INSERT INTO `{tablename}`"))
                    {
                        isInItemTemplateInsert = false;
                    }
                ...
                {
                    if (line.Contains($"INSERT INTO `{tablename}`"))
                    {
                        isInItemTemplateInsert = true;
                    }
                }
