...
namespace ConsoleApp10
{
    internal class Program
    {
        ...
        {
            var entryIndex = FindIndex("entry");
            var nameIndex = FindIndex("name");
            var qualityIndex = FindIndex("Quality");
            var sellPriceIndex = FindIndex("SellPrice");
            ...
            while (line != null)
            {
                ...
                if (isInItemTemplateInsert)
                {
                    ...
                    else if (line.Contains("INSERT INTO") && !line.Contains("INSERT INTO `item_template`"))
                    {
                ...
                {
                    if (line.Contains("INSERT INTO `item_template`"))
                    {
        ...
        private static int FindIndex(string v)
        {
