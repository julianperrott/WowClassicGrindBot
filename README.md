...
`LastAutoShotMs` and `LastMainHandMs` - Upon evaluating the the previusly mentioned fields it will compare the current time, compares how many `Milliseconds` have passed 
