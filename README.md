...
4. When running the BlazorServer for the first time you will have to follow a setup process:
    ...
    4.  Fill the `Author` - this will end up in the addon `.toc` file.
    5.  Fill the `Title` - you can find your installed addon with this given name under `Interface/AddOns/*YourTitle*`
