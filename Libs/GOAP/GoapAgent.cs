...
namespace Libs.GOAP
{
	public sealed class GoapAgent
	{
		...
		public GoapAction? GetAction()
		{
			...
			{
				new KeyValuePair<GoapKey, object>(GoapKey.hastarget, !string.IsNullOrEmpty(playerReader.Target)),
				new KeyValuePair<GoapKey, object>(GoapKey.targetisalive, !playerReader.PlayerBitValues.TargetIsDead),
				...
				new KeyValuePair<GoapKey, object>(GoapKey.shouldheal, playerReader.HealthPercent<60),
			};
